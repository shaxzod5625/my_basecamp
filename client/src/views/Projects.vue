  ...
  <div class="projects">
    <main>
      <div class="container">
        ...
        <div class="projects-filter row justify-content-around">
          <div class="col-3 btn btn btn-outline-secondary btn-sm projects-filter-btn">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-asterisk" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 0a1 1 0 0 1 1 1v5.268l4.562-2.634a1 1 0 1 1 1 1.732L10 8l4.562 2.634a1 1 0 1 1-1 1.732L9 9.732V15a1 1 0 1 1-2 0V9.732l-4.562 2.634a1 1 0 1 1-1-1.732L6 8 1.438 5.366a1 1 0 0 1 1-1.732L7 6.268V1a1 1 0 0 1 1-1z"></path></svg>
            All projects
          </div>
          <div class="col-3 btn btn btn-outline-secondary btn-sm projects-filter-btn">
        ...
        <div class="row mt-5">
          <div class="owner col-4 mb-4" v-for="project in projects" :key="project._id">
            <div class="card project_card">
              ...
              <div class="card-footer border-light">
                <div class="row">
                  ...
                  <div class="col-auto">
                    <a @click.prevent="deleteProject(project._id)" class="btn btn-danger  btn-sm" data-confirm="Are you sure you want to delete this project?" rel="nofollow" data-method="delete" href="">
