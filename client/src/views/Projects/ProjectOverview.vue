  ...
  <div class="container form">
    <div class="row h-100 justify-content-center">
      <div class="col-10 mt-4">
        <router-link tag="a" :to="`/projects/${project.id}/edit`">
        ...
        <div class="row">
          ...
          <div class="d-flex col-10">
            <div class="col py-1" :class="member.role == 'admin' ? 'bg-light rounded' : ''" v-for="member in project.users" :key="member.user_id">
              ...
              <small class="ml-1">{{ member.email }}</small>
            </div>
          </div>
        </div>
        <form role="form" class="new_topic" id="new_topic" action="" @submit.prevent="createDiscussion" accept-charset="UTF-8" method="post">
          <div class="row mt-3">
            <div class="col-6">
              <div class="form-group">
                <label class="text-muted required" for="topic_title">Add new discussion</label>
                <input require="true" class="form-control" type="text" v-model="discussion_title" id="topic_title">
              </div>
            </div>
            <div class="col-4 align-self-end update_btn">
              <button name="button" type="submit" class="btn btn-warning">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 3.5a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5H4a.5.5 0 0 1 0-1h3.5V4a.5.5 0 0 1 .5-.5z"></path><path fill-rule="evenodd" d="M7.5 8a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1H8.5V12a.5.5 0 0 1-1 0V8z"></path><path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"></path></svg>
                New discussion
              </button>
            </div>
          </div>
        ...
        <div v-if="discussions.length">
          <div class="row mt-4" id="topics" v-for="discussion in discussions" :key="discussion.id">
            <div class="col-12 mb-4" id="topic-106">
              <div class="card border-info topic">
                <div class="card-header">
                  <div class="row">
                    <div class="col mr-auto font-weight-bolder text-dark">
                      ...
                      <div class="col-auto">
                        <router-link class="mr-1" tag="a" :to="`/projects/${$route.params.id}/discussion/${discussion._id}/edit`">
                        ...
                        <a @click.prevent="deleteDiscussion(discussion._id)" href="">
                ...
                <div class="card-body overflow-auto messages_list">
                  <div class="row message" v-for="message in discussion.messages" :key="message._id">
                    <div class="col-1">
                      <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chat-text" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M2.678 11.894a1 1 0 0 1 .287.801 10.97 10.97 0 0 1-.398 2c1.395-.323 2.247-.697 2.634-.893a1 1 0 0 1 .71-.074A8.06 8.06 0 0 0 8 14c3.996 0 7-2.807 7-6 0-3.192-3.004-6-7-6S1 4.808 1 8c0 1.468.617 2.83 1.678 3.894zm-.493 3.905a21.682 21.682 0 0 1-.713.129c-.2.032-.352-.176-.273-.362a9.68 9.68 0 0 0 .244-.637l.003-.01c.248-.72.45-1.548.524-2.319C.743 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7-3.582 7-8 7a9.06 9.06 0 0 1-2.347-.306c-.52.263-1.639.742-3.468 1.105z"></path><path fill-rule="evenodd" d="M4 5.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zM4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8zm0 2.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5z"></path></svg>
                    </div>
                    <div class="col">
                    ...
                    <div class="col-auto">
                      <router-link tag="a" :to="`/projects/${$route.params.id}/discussion/${discussion._id}/message/${message._id}`">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M11.293 1.293a1 1 0 0 1 1.414 0l2 2a1 1 0 0 1 0 1.414l-9 9a1 1 0 0 1-.39.242l-3 1a1 1 0 0 1-1.266-1.265l1-3a1 1 0 0 1 .242-.391l9-9zM12 2l2 2-9 9-3 1 1-3 9-9z"></path><path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 0 0 .5.5H4v.5a.5.5 0 0 0 .5.5H5v.5a.5.5 0 0 0 .5.5H6v-1.5a.5.5 0 0 0-.5-.5H5v-.5a.5.5 0 0 0-.5-.5H3z"></path></svg>
                      </router-link>
                    </div>
                  </div>
                </div>
                <div class="card-footer pb-0">
                  <form role="form" @submit.prevent="addMessage(discussion._id)" class="new_message" id="new_message" action="" accept-charset="UTF-8" method="post">
                    <div class="row my-0">
                      <div class="col pr-0">
                        <div class="form-group">
                          <label class="sr-only" for="message_text">Text</label>
                          <input v-model="message" require="true" class="form-control" type="text" name="message[text]" id="message_text">
                        </div>
                      </div>
                      <div class="col-auto align-self-end update_btn">
                        <button name="button" type="submit" class="btn btn-warning">Send</button>
                      </div>
                    </div>
                  </form>
                </div>
        ...
        <form role="form" class="edit_project" id="edit_project_112" @submit.prevent="addFile" action="" method="post">
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                <label class="text-muted" for="project_attachments">Add attachments:</label>
                <div class="custom-file">
                  <input class="custom-file-input overflow-hidden" type="file" id="project_attachments" @change="handleFile">
                  <label class="custom-file-label" for="project_attachments">{{ !fileName ? 'No file chosen' : fileName}}</label>
                </div>
              </div>
            </div>
            <div class="col-auto align-self-end update_btn">
              <button name="button" type="submit" class="btn btn-warning">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M9 1H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h5v-1H4a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h5v2.5A1.5 1.5 0 0 0 10.5 6H13v2h1V6L9 1z"></path><path fill-rule="evenodd" d="M13.5 10a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1H13v-1.5a.5.5 0 0 1 .5-.5z"></path><path fill-rule="evenodd" d="M13 12.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0v-2z"></path></svg>
              </button>
            </div>
          </div>
        </form>
        <div class="projects-attach" id="attachments">
          ...
          <div class="projects-attach-item" v-for="attachment in attachments" :key="attachment._id">
            <a class="btn btn-danger btn-sm" @click.prevent="deleteAttachment(attachment._id)" rel="nofollow" href="">
              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"></path><path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path></svg>
            </a>
            <a href="" @click.prevent="download(attachment._id)">
              {{ attachment.name }}
            </a>
          </div>
        </div>
      ...
      <div class="col">
        <div class="position-fixed justify-content-start mt-4">
          <div class="mb-3">
            <router-link :to="`/projects/${project._id}/edit`" class="btn btn-info">
              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-gear" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8.837 1.626c-.246-.835-1.428-.835-1.674 0l-.094.319A1.873 1.873 0 0 1 4.377 3.06l-.292-.16c-.764-.415-1.6.42-1.184 1.185l.159.292a1.873 1.873 0 0 1-1.115 2.692l-.319.094c-.835.246-.835 1.428 0 1.674l.319.094a1.873 1.873 0 0 1 1.115 2.693l-.16.291c-.415.764.42 1.6 1.185 1.184l.292-.159a1.873 1.873 0 0 1 2.692 1.116l.094.318c.246.835 1.428.835 1.674 0l.094-.319a1.873 1.873 0 0 1 2.693-1.115l.291.16c.764.415 1.6-.42 1.184-1.185l-.159-.291a1.873 1.873 0 0 1 1.116-2.693l.318-.094c.835-.246.835-1.428 0-1.674l-.319-.094a1.873 1.873 0 0 1-1.115-2.692l.16-.292c.415-.764-.42-1.6-1.185-1.184l-.291.159A1.873 1.873 0 0 1 8.93 1.945l-.094-.319zm-2.633-.283c.527-1.79 3.065-1.79 3.592 0l.094.319a.873.873 0 0 0 1.255.52l.292-.16c1.64-.892 3.434.901 2.54 2.541l-.159.292a.873.873 0 0 0 .52 1.255l.319.094c1.79.527 1.79 3.065 0 3.592l-.319.094a.873.873 0 0 0-.52 1.255l.16.292c.893 1.64-.902 3.434-2.541 2.54l-.292-.159a.873.873 0 0 0-1.255.52l-.094.319c-.527 1.79-3.065 1.79-3.592 0l-.094-.319a.873.873 0 0 0-1.255-.52l-.292.16c-1.64.893-3.433-.902-2.54-2.541l.159-.292a.873.873 0 0 0-.52-1.255l-.319-.094c-1.79-.527-1.79-3.065 0-3.592l.319-.094a.873.873 0 0 0 .52-1.255l-.16-.292c-.892-1.64.902-3.433 2.541-2.54l.292.159a.873.873 0 0 0 1.255-.52l.094-.319z"></path><path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"></path></svg>
              Edit Project
            </router-link>
          </div>
          <div>
            <a class="btn btn-warning mb-3" href="">
          ...
          <div>
            <a class="btn btn-warning mb-3" href="">
              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-list-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3.854 2.146a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 3.293l1.146-1.147a.5.5 0 0 1 .708 0zm0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 7.293l1.146-1.147a.5.5 0 0 1 .708 0zm0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0z"></path></svg>
              Tasks
            </a>
          </div>
          <div>
            <a class="btn btn-warning mb-3" href="">
              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M4 1h5v1H4a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V6h1v7a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2z"></path><path d="M9 4.5V1l5 5h-3.5A1.5 1.5 0 0 1 9 4.5z"></path></svg>
              Attachments
            </a>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async getDiscussions() {
      await this.$store.dispatch('getDiscussions', this.$route.params.id)
      this.discussions = this.$store.state.discussions
    },
    async createDiscussion() {
      await this.$store.dispatch('newDiscussion', {
    ...
    async deleteDiscussion(id) {
      await this.$store.dispatch('deleteDiscussion', {
        id: this.$route.params.id,
        discussion_id: id,
      })
      this.getDiscussions()
    },
    async addMessage(discussion_id) {
    ...
    async download(id) {
      const file = this.attachments.find(attachment => attachment._id === id)
      const newFile = new Blob([file.file], {type: file.type})
    ...
    addFile() {
      ...
      reader.onload = async () => {
        const newfile = reader.result.split(',')[1]
        await this.$store.dispatch('newAttachments', {
          id: this.$route.params.id,
          name: this.fileName,
          file: newfile,
        })
